...
class DealerNegetiveStock extends Model
{

    use RainDropsSupport;

    protected $table = 'dealer_negetive_stock';
    ...
    protected $entityName = 'DealerNegetiveStock';
    protected $entityNamePlural = 'DealerNegetiveStock';
