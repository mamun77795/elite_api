...
class DealerNegetiveStockController extends BaseController
{

    protected $modelClass = DealerNegetiveStock::class;
    ...
    public function querying()
    {
        if (\Entrust::hasRole('admin')) {
            $this->dataTableQuery->latest()->where('app_identifier', 'com.smartmux.etracker.user');
