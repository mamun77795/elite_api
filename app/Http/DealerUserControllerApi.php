        ...
        if ($user_token) {
            if ($app_identifier == 'com.ets.elitepaint.dealer') {
                ...
                if ($dealer) {
                    ...
                    //---start transferred point added 11-02-2024 ----//
                    ...
                    $transfered_point = PointTransfer::where('dealer_id', $dealer['id'])
                     ...
                     $dashboard = [
                         ...
                         'product' => 'POINT TRANSFER'.$t_point['painter_id'],
                         'shade_name' => '',
                         'pack_size' => 'N/A',
                     ...
                     //---end transferred point added 11-02-2024 ----//
                ...
                if ($dealer) {
                    ...
                    $all_total_year = 0;
                     ...
                     /// transfered_point added on 11-feb-2024
