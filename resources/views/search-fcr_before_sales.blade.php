    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class = "form-inline" method="POST" action="{{ route('postSearchFcrBeforeSaledate') }}">
                      {{ csrf_field() }}
                       <div class = "form-group">
                         <h3 class="panel-title"><label  for = "fromDate">From Date</label></h3><br>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class = "form-inline" method="POST" action="{{ route('postSearchFcrBeforeSalebreed') }}">
                      {{ csrf_field() }}
                       <div class = "form-group">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class = "form-inline" method="POST" action="{{ route('postSearchFcrBeforeSalefeedmill') }}">
                      {{ csrf_field() }}
                       <div class = "form-group">
