        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class = "form-inline" method="POST" action="{{ route('postSearchLayerLifeCycles') }}">
                      {{ csrf_field() }}
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class = "form-inline" method="POST" action="{{ route('postSearchLayerLifeCycledate') }}">
                      {{ csrf_field() }}
                       <div class = "form-group">
                         <h3 class="panel-title"><label  for = "fromDate">From Date</label></h3><br>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class = "form-inline" method="POST" action="{{ route('postSearchLayerLifeCyclefarm') }}">
                      {{ csrf_field() }}
                       <div class = "form-group">
