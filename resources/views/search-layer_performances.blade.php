        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class = "form-inline" method="POST" action="{{ route('postSearchLayerPerformance') }}">
                      {{ csrf_field() }}
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class = "form-inline" method="POST" action="{{ route('postSearchLayerPerformancedate') }}">
                      {{ csrf_field() }}
                       <div class = "form-group">
                         <h3 class="panel-title"><label  for = "fromDate">From Date</label></h3><br>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class = "form-inline" method="POST" action="{{ route('postSearchLayerPerformancebreed') }}">
                      {{ csrf_field() }}
                       <div class = "form-group">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class = "form-inline" method="POST" action="{{ route('postSearchLayerPerformancefeedmill') }}">
                      {{ csrf_field() }}
                       <div class = "form-group">
