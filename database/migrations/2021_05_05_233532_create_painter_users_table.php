...
class CreatePainterUsersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('painter_users', function (Blueprint $table) {
            $table->increments('id');
            $table->string('elite_member_id');
            $table->string('painter_member_id');
    ...
    {
        Schema::dropIfExists('painter_users');
    }
}
